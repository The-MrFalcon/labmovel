...
class Home extends BaseController
{
    public function index()
    {
        ...
        return view('template/header/header')
            ...
            . view('pages/index/exames')
            . view('pages/index/etapas')
            . view('pages/index/testimonial')
            . view('pages/index/modal/biologia_molecular')
            . view('pages/index/modal/medicina_personalizada')
            . view('pages/index/modal/bioquimica')
            . view('pages/index/modal/imunologia')
            . view('pages/index/modal/genetica')
            . view('pages/index/modal/citogenetica')
            . view('pages/index/modal/microbiologia')
            . view('pages/index/modal/hematologia')
            . view('pages/index/modal/hormonios')
            . view('pages/index/modal/outros')
            // Estrutura Footer
